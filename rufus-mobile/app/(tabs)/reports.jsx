...
const KPI_DATA = [
  ...
  { label: 'Avg RUFUS Score', value: '76.3', icon: 'star-outline', color: Colors.cyan },
  { label: 'Pre-Approval Rate', value: '50%', icon: 'checkmark-circle-outline', color: Colors.green },
  { label: 'Avg Processing', value: '1.2 days', icon: 'time-outline', color: Colors.amber },
  { label: 'Flagged for Review', value: '2', icon: 'flag-outline', color: Colors.red },
];
...
const QUEUE_DATA = [
  {
    ...
    action: 'Fast-Track Approve', actionColor: Colors.green, actionBg: Colors.greenLight,
  ...
  },
  {
    ...
    action: 'Manual Review', actionColor: Colors.amber, actionBg: Colors.amberLight,
...
const SCORE_DIST = [
  { range: '80–100', count: 2, color: Colors.green },
  { range: '70–79', count: 1, color: Colors.cyan },
  { range: '60–69', count: 1, color: Colors.amber },
  { range: '50–59', count: 0, color: Colors.red },
];
          ...
          <View key={item.id} style={styles.queueCard}>
            ...
            <View style={styles.queueRight}>
              ...
              <View style={styles.queueBtns}>
                <TouchableOpacity
                  style={[styles.qBtn, { backgroundColor: Colors.green }]}
                  onPress={() => Alert.alert('Approved', `${item.business} approved.`)}
                >
                  <Text style={styles.qBtnText}>Approve</Text>
                </TouchableOpacity>
                <TouchableOpacity
                  style={[styles.qBtn, { backgroundColor: Colors.amber }]}
...
const styles = StyleSheet.create({
  ...
  kpiCard: {
    width: 130, backgroundColor: Colors.white, borderRadius: 12,
  ...
  kpiLabel: { fontSize: 11, color: Colors.slate500, marginTop: 4, fontWeight: '600', textAlign: 'center' },

  callout: {
    flexDirection: 'row', alignItems: 'center', gap: 8,
    backgroundColor: Colors.greenLight, borderRadius: 10, padding: 12, marginBottom: 16,
  },
  calloutText: { fontSize: 13, color: Colors.green, fontWeight: '600', flex: 1 },
  ...
  queueMain: { flex: 1 },
  queueBusiness: { fontSize: 13, fontWeight: '700', color: Colors.slate900, marginBottom: 4 },
  queueMeta: { flexDirection: 'row', marginBottom: 4 },
  queueScore: { fontSize: 12, color: Colors.slate600 },
  queueConf: { fontSize: 12, color: Colors.slate500 },
  ...
  qBtnText: { fontSize: 11, fontWeight: '700', color: Colors.white },
  ...
  distRange: { width: 56, fontSize: 12, fontWeight: '600', color: Colors.slate600 },
  distBarBg: { flex: 1, height: 10, backgroundColor: Colors.slate100, borderRadius: 5, overflow: 'hidden', marginHorizontal: 10 },
